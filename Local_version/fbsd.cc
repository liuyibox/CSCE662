...
std::string localServer="localhost:";
std::string leaderAddr="localhost:9000";
...
int find_server_ID(std::string addr){
	...
	if(addr.compare("localhost:6004") <= 0) return 0;
	if(addr.compare("localhost:6007") <= 0) return 1;
	return 2;
...
int main(int argc, char** argv) {
	...
	server0.push_back("localhost:6001");
	server0.push_back("localhost:6002");
	server0.push_back("localhost:6003");
	server0.push_back("localhost:6004");
	server1.push_back("localhost:6005");
	server1.push_back("localhost:6006");
	server1.push_back("localhost:6007");
	server2.push_back("localhost:6008");
	server2.push_back("localhost:6009");
	server2.push_back("localhost:6010");
