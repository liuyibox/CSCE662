...
static const char* RegisterServer_method_names[] = {
  ...
  "/assignment2.RegisterServer/updateDatabase",
};
...
RegisterServer::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_updateDatabase_(RegisterServer_method_names[1], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status RegisterServer::Stub::updateDatabase(::grpc::ClientContext* context, const ::assignment2::DataSync& request, ::assignment2::ServerReply* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_updateDatabase_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::assignment2::ServerReply>* RegisterServer::Stub::AsyncupdateDatabaseRaw(::grpc::ClientContext* context, const ::assignment2::DataSync& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::ClientAsyncResponseReader< ::assignment2::ServerReply>::Create(channel_.get(), cq, rpcmethod_updateDatabase_, context, request);
}
...
RegisterServer::Service::Service() {
  ...
  AddMethod(new ::grpc::RpcServiceMethod(
      ...
      new ::grpc::RpcMethodHandler< RegisterServer::Service, ::assignment2::DataSync, ::assignment2::ServerReply>(
          std::mem_fn(&RegisterServer::Service::updateDatabase), this)));
}
...
::grpc::Status RegisterServer::Service::updateDatabase(::grpc::ServerContext* context, const ::assignment2::DataSync* request, ::assignment2::ServerReply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
